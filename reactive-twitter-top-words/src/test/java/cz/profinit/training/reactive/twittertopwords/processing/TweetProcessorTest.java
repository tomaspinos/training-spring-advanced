...
public class TweetProcessorTest {
    ...
    private TweetToStatsConverter processor;

    @Before
    public void setUp() {
        processor = new TweetToStatsConverter();
    }

    @Test
    public void shouldProcessTweet() {
        for (WordSplitTestCase testCase : testCases) {
            TweetStats tweetStats = processor.toStats(tweet(testCase));
    ...
    private static class WordSplitTestCase {
        ...
        static WordSplitTestCase of(String text, Map<String, Integer> wordCounts) {
